...
class U_Net_Multi2_add(nn.Module):
    '''
    unet模型 + 多尺度 + 单层卷积     U_Net_Multi
    num_classes 类别数
    '''
    def __init__(self, num_classes=2):
        super(U_Net_Multi2_add, self).__init__()
...
class U_Net_Multi2_dws_add(nn.Module):
    '''
    unet模型 + 多尺度 + 单层卷积     U_Net_Multi
    num_classes 类别数
    '''
    def __init__(self, num_classes=2):
        super(U_Net_Multi2_dws_add, self).__init__()
...
class U_Net_Multi_cbam_add(nn.Module):
    '''
    unet模型 + 多尺度 + cbam
    num_classes 类别数
    '''
    def __init__(self, num_classes=2):
        super(U_Net_Multi_cbam_add, self).__init__()
